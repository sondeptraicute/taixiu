...
$data_bc = $mysqli->query("SELECT * FROM `nguoichoi` ORDER by win DESC LIMIT $start, $kmess");
$log = array();
while($phien=$data_bc->fetch_assoc())
{
   $msg.='<tr id="count"><td>#'.$phien['id'].' - '.$phien['taikhoan'].' </td> <td>'.number_format($phien['win']).' </td>    </tr>';
}
...
<h2 class="panel-title">Đua Top Hằng Ngày</h2>
</header>
<div class="panel-body">
<b><font color="red">PHẦN THƯỞNG TOP SẼ ĐƯỢC CHỐT VÀO LÚC 22:30 HẰNG NGÀY !</b></font><br>
<b><font color="red">🏅 TOP 1: Thưởng 300k XU</b></font><br>
<b><font color="red">🥈 TOP 2: Thưởng 200K XU</b></font><br>
<b><font color="red">🥉 TOP 3: Thưởng 100K XU</b></font><br>
<b><font color="red">🏅 Top4-10: Thưởng 50k XU</b></font><br>
