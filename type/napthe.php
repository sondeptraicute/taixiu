...
<h2 class="panel-title"><a href="/game/napthe" class="btn btn-success mr-2" type="submit" style="margin-top:5px" id="thaiBtn">NẠP THẺ</a> <a href="/game/napbank" class="btn btn-success mr-2" type="submit" style="margin-top:5px" id="thaiBtn">NẠP ATM</a></h2>
</header>
<b><font color="red">*Lưu Ý: Nạp Sai Mệnh Giá Có Thể Mất Thẻ,Vui Lòng Kiểm Tra Kỹ Trước Khi Nạp</b></font><br>
<b><font color="red">*Tỉ Lệ Nạp Thẻ ( 100k Card = 77k Xu )</b></font><br>
                        ...
                        <option value="1000000">1.000.000</option>
                                    ...
                                    <div class="form-group">
                                        <label>Seri:</label>
                                            ...
                                            <input placeholder="Seri" type="number" class="form-control" placeholder="" id="serial"  name="serial" value="" aria-describedby="basic-addon11">
                                    ...
                                    <div class="form-group">
                                        <label>Mã thẻ:</label>
                                            ...
                                            <input placeholder="Mã thẻ" type="number" class="form-control" placeholder="" id="code"  name="code" value="" aria-describedby="basic-addon11">
                                        
                                    </div>
                                    
                                     
                   <button type="button" onclick="napthe()" class="btn btn-success mr-2"  type="submit" style="margin-top:5px" id="thaiBtn">Nạp Ngay</button>
