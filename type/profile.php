...
if($id >=1)
{
    $thongtin.='ID Tài khoản : <b><font color="red">'.$datauser->id.'</font></b><br>';
    $thongtin.='Tên tài khoản : '.$datauser->taikhoan.'<br>';
    $thongtin.='Số tiền có : '.number_format($datauser->xu).'<br>';
...
<h2 class="panel-title">Cá nhân</h2>

</header>  
<div class="panel-body">
<p class="card-description"> <?=($id >=1 ? 'Thông tin cá nhân' : 'Vui lòng đăng nhập để tiếp tục' )?>        </p>
                    <?=$thongtin?>
                  </div>
                </div>
              </div>
