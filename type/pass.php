    ...
    <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body" id="form_data">
                    ...
                    <p class="card-description"> Vui lòng nhập mật khẩu cũ và mật khẩu mới cần đổi.</p>
                    <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                          <span class="input-group-text">Mật khẩu hiện tại</span>
                        </div>
                        <input type="text" class="form-control" placeholder="" id="taikhoan" name="cu" aria-label="Username" aria-describedby="basic-addon1">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="password" class="form-control" placeholder="" id="taikhoan" name="matkhau" aria-label="Username" aria-describedby="basic-addon1">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="password" class="form-control" placeholder="" id="taikhoan" name="matkhau2" aria-label="Username" aria-describedby="basic-addon1">
                      </div>
                    </div>
                   ...
                   <button type="button" onclick="doipass()" class="btn btn-gradient-info btn-rounded btn-fw">Đổi mật khẩu</button>
